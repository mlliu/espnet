...
def check_short_utt(ins, size):
    ...
    if isinstance(ins, Conv1dSubsampling3) and size < 7:
        return True, 7
    if isinstance(ins, Conv1dSubsampling4) and size < 9:
        return True, 9
...
class Conv1dSubsampling4(torch.nn.Module):
    """Convolutional 1D subsampling.
    ...
    def __init__(self, idim, odim, dropout_rate, pos_enc=None):
        """Construct an Conv1dSubsampling4 object."""
        super(Conv1dSubsampling4, self).__init__()
        self.conv = torch.nn.Sequential(
