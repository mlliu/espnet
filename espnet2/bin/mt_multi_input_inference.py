...
class Text2Text:
    ...
    def __init__(
        ...
        # 1. Build MT model
        scorers = {}
        mt_model, mt_train_args = MTTask_multi_input.build_model_from_file(
...
def inference(
    ...
    loader = MTTask_multi_input.build_streaming_iterator(
        data_path_and_name_and_type,
        dtype=dtype,
        batch_size=batch_size,
        key_file=key_file,
        num_workers=num_workers,
        preprocess_fn=MTTask_multi_input.build_preprocess_fn(text2text.mt_train_args, False),
        collate_fn=MTTask_multi_input.build_collate_fn(text2text.mt_train_args, False),
